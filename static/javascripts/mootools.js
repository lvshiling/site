...
Example:
	(start code)
	var dlg = new Dialog({maskColor:'#2C478F'});
...
var Dialog = new Class({
	...
	box: function(title){
		...
		$('dialog_title').addEvent('mousedown', function(){new Drag.Move($('dialog_window'));});
		$('dialog_title').setStyle('cursor', 'move');
		$('dialog_title').setStyle('width', this.options.width - 40);
		...
		$('dialog_close').addEvent('click', this.hide.bind(this));
		$('dialog_close').setStyle('cursor', 'pointer');
		...
		$('dialog_window').inject(this.pop, 'inside');
		$('dialog_window').setStyles({
		...
		this.mask.setStyle('opacity', '0.5');
		this.pop.setStyle('top', window.getScrollTop() + 120);

		this.periodical = this.update.periodical(100, this);
	},

	show: function(content){
		$('dialog_content').setHTML(content);
	},
	...
	hide: function(){
		if (this.pop.getStyle('display') == 'none') return;
