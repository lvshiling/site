...
<table class="list_style" cellpadding="0" cellspacing="0" border="1" frame="void">
  ...
  <tr class="alt1">
    ...
    <td><input type="radio" name="can_manage_data" value="1" <!--{if $Manager.can_manage_data}-->checked="checked"<!--{/if}--> />允许&nbsp;<input type="radio" name="can_manage_data" value="0" <!--{if !$Manager.can_manage_data}-->checked="checked"<!--{/if}--> />禁止</td>
  </tr>
  <tr class="alt2">
