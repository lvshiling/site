...
<tr><td class="text_right" width="180">管理操作：</td><td><input type="radio" name="upgrade" value="1" checked="checked" />提升资源&nbsp;<input type="radio" name="upgrade" value="0" />下沉资源<br /><span class="form_clue">提升资源的种子数不少于<!--{$Config.upgrade_least_seeder}-->且两次提升间隔时间不小于<!--{$Config.upgrade_space_time}-->小时</span></td></tr>
</table>
