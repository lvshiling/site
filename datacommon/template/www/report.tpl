...
<link rel="stylesheet" type="text/css" href="<!--{$Config.domain_static}-->/css/global.css?v20080321" />
...
<input type="hidden" name="url" value="<!--{$ReportUrl}-->" />
<div class="nav_title clear text_bold"><!--{$SiteTitle}--></div>
<table class="list_style">
  <tr class="alt1">
    <td class="text_right" width="20%">举报地址</td>
    <td width="80%"><a href="<!--{$ReportUrl|urldecode}-->" target="_blank"><!--{$ReportUrl|urldecode}--></a></td>
  </tr>
  <tr class="alt2">
