<?php /* Smarty version 2.6.19, created on 2011-04-02 14:23:58
...
/css/global.css?v20080318" />
<script type="text/javascript" src="<?php echo $this->_tpl_vars['Config']['domain_static']; ?>
/javascripts/mootools.js?v20080318"></script>
<script type="text/javascript" src="<?php echo $this->_tpl_vars['Config']['domain_static']; ?>
/javascripts/global.js?v20080318"></script>
<style>
...
<div class="top_menu">
<p class="left">&nbsp;</p>
<p class="right"><a href="<?php echo $this->_tpl_vars['Config']['domain_www']; ?>
">返回首页</a></p>
</div>
...
<p>在&nbsp;<select id="sort_id" name="sort_id"><option value="0">所有</option><?php echo $this->_tpl_vars['SortOption']; ?>
</select>&nbsp;分类下搜索&nbsp;<select><option value="title">标题</option></select>&nbsp;中</p>
...
<p><a href="#">联系我们</a> - <a href="<?php echo $this->_tpl_vars['Config']['domain_comment']; ?>
/report.php" target="_blank">意见反馈</a></p>
