<?php /* Smarty version 2.6.19, created on 2011-04-01 13:45:42
         compiled from create_html.tpl */ ?>
...
<table class="list_style" cellpadding="0" cellspacing="0" border="1" frame="void">
  <tr class="alt1">
	...
	<td width="80%">
	<input type="text" class="formInput" id="start_date" name="start_date" value="<?php echo $this->_tpl_vars['CurrentDate']; ?>
" readonly="readonly" size="10" maxlength="10" onclick='showCalendar(this, $("start_date"), "yyyy-mm-dd",null,0,-1,-1)' /> - 
	<input type="text" class="formInput" id="last_date" name="last_date" value="<?php echo $this->_tpl_vars['CurrentDate']; ?>
" readonly="readonly" size="10" maxlength="10" onclick='showCalendar(this, $("last_date"), "yyyy-mm-dd",null,0,-1,-1)' /> 之间
	</td>
  </tr>
  <tr class="alt2">
