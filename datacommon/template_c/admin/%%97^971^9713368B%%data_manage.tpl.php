<?php /* Smarty version 2.6.19, created on 2011-04-02 17:17:39
         compiled from data_manage.tpl */ ?>
...
//var manage_option = new Array('commend', 'heightlight');
var manage_option = new Array('heightlight');
function executeOperate()
{
	...
	if ('delete' == s_type || 'auditing' == s_type)
	{
		if ('delete' == s_type)
		{
			$('manage_area').style.display = 'none';
